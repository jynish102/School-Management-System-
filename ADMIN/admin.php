...
if (!isset($_SESSION['login']) || $_SESSION['login'] !== true || strtolower($_SESSION['user_type']) !== 'admin') {
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-body text-center py-4">
                <img src="https://i.gifer.com/7efs.gif" alt="Success" width="100" alt=" Success" style="width: 100px; margin-bottom: 15px;">
